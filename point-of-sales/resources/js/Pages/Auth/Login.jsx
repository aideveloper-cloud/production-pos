...
export default function Login({ status, canResetPassword, canRegister, botGuard, isWarehouseMode }) {
    ...
    const title = isWarehouseMode
        ? t("warehouse.pos.loginTitle", { defaultValue: "เข้าเครื่อง POS" })
        : t("auth.login.subtitle");
    const description = isWarehouseMode
        ? t("warehouse.pos.loginDescription", {
              defaultValue: "ล็อกอินแล้วเปิดหน้าตัด/รับสต็อกทันที",
          })
        : t("auth.login.description");
    const appName = isWarehouseMode
        ? t("warehouse.pos.brand", { defaultValue: "เครื่อง POS คลัง" })
