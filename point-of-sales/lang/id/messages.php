...
return [
    ...
    */
        ...
        'warehouse_floor' => [
            'receive_posted' => 'Penerimaan dicatat: :qty :uom',
            'cut_posted' => 'Pemotongan dicatat: :qty :uom',
            'cut_exceeds' => 'Tidak bisa potong :qty :uom; sisa :remaining :remaining_uom.',
            'uom_mismatch' => 'Tidak bisa mengonversi :from ke :to untuk barang ini.',
        ],
    ...
    */
    'inventory' => [
        'insufficient' => 'Stok :product di gudang ini tidak cukup (tersedia :available :uom, diminta :qty).',
        'transit_unit_missing' => 'Unit dalam transfer ini sudah tidak ada; transfer tidak bisa diterima.',
    ],
    'validation' => [
