...
return [
    ...
    */
    ...
    'warehouse_floor' => [
        'receive_posted' => 'Receive posted: :qty :uom',
        'cut_posted' => 'Cut posted: :qty :uom',
        'cut_exceeds' => 'Cannot cut :qty :uom; remaining is :remaining :remaining_uom.',
        'uom_mismatch' => 'Cannot convert :from to :to for this item.',
        'invalid_pin' => 'Invalid warehouse PIN.',
        'scan_not_found' => 'No unit or product found for scanned code.',
    ],
    ...
    */
    'inventory' => [
        'insufficient' => 'Not enough :product in this warehouse (available :available :uom, requested :qty).',
        'transit_unit_missing' => 'A unit on this transfer no longer exists; the transfer cannot be received.',
    ],
    'validation' => [
