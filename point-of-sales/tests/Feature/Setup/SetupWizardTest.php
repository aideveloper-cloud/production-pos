...
class SetupWizardTest extends TestCase
{
    ...
    public function test_root_redirects_to_pos_after_install(): void
    {
        Setting::set('app_setup_completed', true);

        $this->get('/')->assertRedirect(route('pos.index'));
    }
    ...
    public function test_setup_page_is_hidden_after_install(): void
    {
        Setting::set('app_setup_completed', true);

        $this->get(route('setup.index'))->assertNotFound();
        $this->post(route('setup.store'), $this->validPayload())->assertNotFound();
    }
